        ...
        <div class="card-container">
            ...
            <div class="card">
                 ...
                 <div class="card-content">
                    ...
                    <div class="card-actions">
                        <!-- Enlace al formulario de productos (crear/actualizar) -->
                        <a href="Productos/producto.php" class="action-link">Formulario</a>
                        <!-- Enlace a la tabla de productos existentes -->
                        <a href="Productos/read.php" class="action-link">Ver Tabla</a>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <div class="card-actions">
                        <a href="DetalleVenta/venta.php" class="action-link">Nueva Venta</a>
                        <a href="DetalleVenta/ventas.php" class="action-link">Ver Ventas</a>
                    </div>
                </div>
            </div>
